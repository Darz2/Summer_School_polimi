...
echo "Temperature[K] Density-s0[kg/m3] SD-Density-s0[kg/m3] Density-s1[kg/m3] SD-Density-s1[kg/m3]" >> $outdir/VLE_density.dat
...
for t in "${temp[@]}"; do
    ...
    echo "$t $density_s0 $SD_density_s0 $density_s1 $SD_density_s1" >> $outdir/VLE_density.dat
